      ...
      <section className="band" id="archive">
        <div className="wrap">
          ...
          <div className="rv" style={{marginTop:'56px', display:'flex', justifyContent:'space-between', alignItems:'center', flexWrap:'wrap', gap:'16px', borderTop:'1px solid var(--line)', paddingTop:'34px'}}>
            ...
            <a href="tel:+441483870170" className="btn-line">See recent case studies <span className="arw">→</span></a>
          </div>
        </div>
      </section>
      ...
      <footer>
        <div className="foot-nav">
          <div className="wrap">
            ...
            <nav className="nav"><a href="#">Practice</a><a href="#">Work</a><a href="#">Studio</a><a href="#">Writing</a><a href="#">Contact</a></nav>
            <a href="tel:+441483870170" className="top-cta">Start a project</a>
          </div>
        </div>
        <div className="cols">
