    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-6 py-24">
        ...
        <div className="max-w-2xl mb-24">
          <h2 className="text-sm font-semibold uppercase tracking-widest text-[var(--color-muted)] mb-8">Founder</h2>
          ...
          <div className="flex gap-4 mt-6">
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-sm text-[var(--color-accent)] hover:underline">LinkedIn</a>
            <a href="https://quantime.uk" target="_blank" rel="noopener noreferrer" className="text-sm text-[var(--color-accent)] hover:underline">Quantime</a>
          </div>
        </div>

        {/* India team */}
        <div className="max-w-2xl mb-24">
          <h2 className="text-sm font-semibold uppercase tracking-widest text-[var(--color-muted)] mb-8">Implementation team</h2>
        ...
        <div className="max-w-2xl">
          <h2 className="text-sm font-semibold uppercase tracking-widest text-[var(--color-muted)] mb-8">The agent stack</h2>
          ...
          <div className="grid grid-cols-2 gap-4">
            {agents.map((a) => (
              <div key={a.name} className="border border-black/10 rounded-xl p-6">
                <h3 className="font-semibold mb-2">{a.name}</h3>
                <p className="text-sm text-[var(--color-muted)]">{a.role}</p>
              </div>
            ))}
          </div>
        </div>
