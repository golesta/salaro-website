      ...
      <div className="max-w-7xl mx-auto px-6 py-24 space-y-24">
        ...
        <section className="max-w-2xl">
          ...
          <ul className="space-y-3 text-base text-fg-mute">
            <li className="flex gap-3"><span className="text-accent">—</span>Businesses running or building a listings or directory site</li>
            <li className="flex gap-3"><span className="text-accent">—</span>Existing GeoDirectory users hitting performance or feature walls</li>
            <li className="flex gap-3"><span className="text-accent">—</span>WordPress sites that need genuinely custom development, not plugin stacking</li>
            <li className="flex gap-3"><span className="text-accent">—</span>Teams migrating from another directory platform to GeoDirectory</li>
          </ul>
        </section>

        <section className="max-w-2xl">
          <h2 className="text-sm font-semibold uppercase tracking-widest text-fg-mute mb-6">How we deliver it</h2>
          <p className="text-base leading-relaxed text-fg-mute">Our India team maintains deep WordPress and GeoDirectory expertise built across many live projects. Agent-assisted development speeds up repetitive work (custom post type registration, field mapping, query optimisation scaffolding) while senior review keeps quality consistent.</p>
        </section>
