      ...
      <div className="max-w-7xl mx-auto px-6 py-24 space-y-24">
        ...
        <section className="max-w-2xl">
          ...
          <ul className="space-y-3 text-base text-fg-mute">
            <li className="flex gap-3"><span className="text-accent">—</span>Businesses with technically demanding web requirements</li>
            <li className="flex gap-3"><span className="text-accent">—</span>Teams who've outgrown their current platform and need a migration path</li>
            <li className="flex gap-3"><span className="text-accent">—</span>Organisations managing multiple web properties that need a shared architecture</li>
            <li className="flex gap-3"><span className="text-accent">—</span>Anyone who's been turned down by a cheaper agency and needs it done right</li>
          </ul>
        </section>

        <section className="max-w-2xl">
          <h2 className="text-sm font-semibold uppercase tracking-widest text-fg-mute mb-6">How we deliver it</h2>
          <p className="text-base leading-relaxed text-fg-mute">Discovery first, always. We scope the build before we quote it. Then we run a structured delivery cycle: architecture, implementation, review, ship. The India team handles execution; the senior team handles architecture and client decisions.</p>
        </section>
